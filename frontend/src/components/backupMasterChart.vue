        ...
        <template #end>
            <div class="col-md-2">
                ...
                <div class="flex align-items-center">
                    <Checkbox :inputId="option.key" :value="option.namaRuangan" v-model="selectedInfo" />
                ...
                <Dropdown v-model="selectedKdRuangan" :options="dropdownRuangan" optionLabel="label" optionValue="value"
                    placeholder="Pilih Ruangan" class="mr-2" />
                ...
                <Button @click="searchData" label="Cari" icon="pi pi-search" />
            </div>
        </template>
    </Menubar>
...
const selectedKdRuangan = ref(null);
